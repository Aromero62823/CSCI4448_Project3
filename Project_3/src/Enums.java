public class Enums {
    ...
    public enum vehicleType {PerformanceCar, Car, Pickup, ElectricCar, MonsterTruck, Motorcycle, Bicycle, SuperCar, OffRoad}
    public enum vehicleCondition {New, Used, Broken}
